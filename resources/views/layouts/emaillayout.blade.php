                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="600" id="template_header"
                                ...
                                <tr>
                                    <td id="header_wrapper" style="padding: 36px 48px; display: block;">
                                        <h1 style='color: #ffffff; font-family: "Helvetica Neue", Helvetica, Roboto, Arial, sans-serif; font-size: 30px; font-weight: 300; line-height: 150%; margin: 0; text-align: left; text-shadow: 0 1px 0 #7797b4; -webkit-font-smoothing: antialiased;'>{{$subject}}</h1>
                                    </td>
                                </tr>
                            </table>
                            <!-- End Header -->
                                        ...
                                        <table border="0" cellpadding="10" cellspacing="0" width="100%">
                                            <tr>
                                                <td colspan="2" valign="middle" id="credit"
                                                    ...
                                                    {{--<p>WebSite – Powered by WooCommerce</p>--}}
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
