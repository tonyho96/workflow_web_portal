        ...
        <header class="main-header">
            @if(config('adminlte.layout') == 'top-nav')
                ...
                <img style="width: 50px; height: 50px;"
                     src="https://www.fama.org/wp-content/plugins/bp-custom-users/includes/img/logo.png" alt="logo"/>
                                    {!! config('adminlte.logo_mini', '<b>A</b>LT') !!}
                </span>
                                <!-- logo for regular state and mobile devices -->
                                <span class="logo-lg">
                    <img style="width: 50px; height: 50px;"
                         src="https://www.fama.org/wp-content/plugins/bp-custom-users/includes/img/logo.png"
                         alt="logo"/>
                                    {!! config('adminlte.logo', '<b>Admin</b>LTE') !!}
                </span>
                            </a>
